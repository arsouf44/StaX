...
export const COMMON_ONBOARDING: readonly OnboardingQuestion[] = [
  {
    ...
    type: 'text',
    required: true,
    placeholder: 'Tel qu’il doit apparaître sur le site',
  },
  {
    id: 'city',
    ...
    type: 'text',
    required: true,
    help: 'Determinant pour votre référencement local.',
  },
  {
    id: 'phone',
    label: 'Numéro de téléphone affiche sur le site',
    type: 'text',
    required: true,
  },
  {
  ...
  {
    id: 'has_photos',
    label: 'Disposez-vous de photos de votre activité ?',
    type: 'boolean',
    required: true,
  ...
  {
    id: 'existing_website',
    label: 'Avez-vous déjà un site internet ?',
    type: 'url',
    required: false,
    placeholder: 'https://',
  },
...
export const SECTORS: readonly SectorDefinition[] = [
  {
    id: 'restauration',
    label: 'Restauration',
    description: 'Restaurants, bars, boulangeries, traiteurs et métiers de bouche.',
    icon: 'utensils',
    sortOrder: 10,
    ...
    onboarding: [
      ...
      {
        id: 'accepts_bookings',
        label: 'Souhaitez-vous recevoir des réservations depuis le site ?',
        type: 'boolean',
        required: true,
      },
      {
  ...
  },
  {
    ...
    description: 'Coiffure, esthétique, spa, massage et soins du corps.',
    icon: 'sparkles',
    sortOrder: 20,
    ...
    defaultPages: [
      ...
      page('/equipe', 'L’équipe', 'team', ['section-heading', 'team']),
      CONTACT_PAGE,
    ],
    onboarding: [
      {
  ...
  },
  {
    ...
    description: 'Métiers du bâtiment, de la rénovation et de l’artisanat.',
    icon: 'hammer',
    sortOrder: 30,
    ...
    defaultPages: [
      ...
      page('/realisations', 'Réalisations', 'standard', ['section-heading', 'portfolio']),
    ...
    onboarding: [
      {
        ...
        type: 'textarea',
        required: true,
        help: 'Determinant pour apparaître dans les recherches locales.',
      },
      {
        id: 'emergency',
  ...
  },
  {
    ...
    description: 'Commerces de proximité, boutiques et vente en ligne.',
    icon: 'shopping-bag',
    sortOrder: 40,
  ...
  },
  {
    ...
    onboarding: [
      ...
      {
        id: 'credentials',
        label: 'Diplômes, ordres professionnels ou agréments a mentionner ?',
        type: 'text',
        required: false,
      },
    ],
  ...
  },
  {
    ...
    description: 'Hôtels, chambres d’hôtes, gîtes et activités touristiques.',
    icon: 'bed-double',
    sortOrder: 70,
    ...
    onboarding: [
      {
        id: 'room_count',
        label: 'Combien de chambres ou d’hébergements proposez-vous ?',
        type: 'number',
        required: true,
      },
      {
        id: 'booking_mode',
        label: 'Comment souhaitez-vous recevoir les réservations ?',
        type: 'select',
        required: true,
        options: [
      ...
      {
        id: 'breakfast',
        label: 'Le petit-dejeuner est-il inclus ?',
        type: 'boolean',
        required: false,
      },
    ],
  ...
  },
  {
    ...
    description: 'Praticiens, cabinets et professions de santé.',
    icon: 'stethoscope',
    sortOrder: 80,
    defaultModules: [...COMMON_MODULES, 'opening-hours', 'services', 'team'],
    defaultPages: [
      ...
      page('/soins', 'Soins proposés', 'services', ['section-heading', 'services']),
      CONTACT_PAGE,
    ],
    onboarding: [
      {
      ...
      {
        id: 'rpps',
        label: 'Numéro RPPS ou ADELI a afficher',
        type: 'text',
        required: false,
      },
    ],
  ...
  },
  {
    ...
    description: 'Garages, carrosseries, concessions et mobilité.',
    icon: 'car',
    sortOrder: 90,
  ...
  },
  {
    id: 'sport',
    label: 'Sport & loisirs',
    description: 'Salles, clubs, coachs et activités sportives.',
    icon: 'dumbbell',
    sortOrder: 100,
    defaultModules: [...COMMON_MODULES, 'opening-hours', 'services', 'team'],
    defaultPages: [
      HOME(['hero', 'intro', 'services', 'gallery', 'team', 'testimonials', 'cta']),
      page('/activites', 'Nos activités', 'services', ['section-heading', 'services']),
  ...
  },
  {
    id: 'evenementiel',
    label: 'Événementiel',
    description: 'Organisation, prestation et location événementielle.',
    icon: 'party-popper',
    sortOrder: 110,
    ...
    onboarding: [
      {
        id: 'event_types',
        label: 'Quels types d’événements traitez-vous ?',
        type: 'text',
        required: true,
      },
      {
        id: 'coverage',
        label: 'Quelle zone geographique couvrez-vous ?',
        type: 'text',
        required: false,
      },
    ],
  ...
  },
  {
    ...
    description: 'Écoles, formateurs, soutien scolaire et auto-écoles.',
    icon: 'graduation-cap',
    sortOrder: 120,
  ...
  },
  {
    id: 'associations',
    label: 'Associations',
    description: 'Associations, clubs et structurés a but non lucratif.',
    ...
    onboarding: [
      {
        id: 'mission',
        label: 'Quelle est la mission de l’association ?',
        type: 'textarea',
        required: true,
      },
      {
        id: 'members',
        label: 'Combien d’adhérents comptez-vous ?',
        type: 'number',
        required: false,
      },
      {
        id: 'donations',
        label: 'Souhaitez-vous recevoir des dons en ligne ?',
        type: 'boolean',
        required: false,
      },
    ],
  ...
  },
  {
    ...
    description: 'Votre métier n’apparaît pas ? Nous l’ajoutons pour vous.',
    ...
    onboarding: [
      {
        ...
        label: 'Decrivez votre activité en quelques lignes',
        type: 'textarea',
        required: true,
      },
    ],

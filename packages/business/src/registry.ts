...
const SPECS: readonly BusinessSpec[] = [
  /* --- Restauration ------------------------------------------------------ */
  {
    ...
    sortOrder: 10,
    extraModules: ['booking', 'team'],
    vocabulary: RESTAURANT_VOCAB,
    seoKeywords: ['restaurant', 'réserver une table', 'menu', 'carte'],
  },
  {
    id: 'pizzeria',
    sector: 'restauration',
    name: 'Pizzeria',
    pluralName: 'Pizzerias',
    icon: 'pizza',
    schemaOrgType: 'Restaurant',
    sortOrder: 20,
  ...
  },
  {
    ...
    sector: 'restauration',
    name: 'Pâtisserie',
    pluralName: 'Pâtisseries',
    icon: 'cake-slice',
    schemaOrgType: 'Bakery',
    sortOrder: 70,
    extraModules: ['products', 'orders', 'payments', 'team'],
    vocabulary: SHOP_VOCAB,
  },
  {
    id: 'traiteur',
    sector: 'restauration',
    name: 'Traiteur',
    pluralName: 'Traiteurs',
    icon: 'chef-hat',
    schemaOrgType: 'FoodService',
    sortOrder: 80,
    extraModules: ['quotes', 'portfolio'],
    vocabulary: RESTAURANT_VOCAB,
  },
  {
    id: 'food-truck',
  ...
  },
  {
    ...
    pluralName: 'Boucheries',
    icon: 'beef',
    schemaOrgType: 'Store',
    sortOrder: 100,
    extraModules: ['products'],
    removeModules: ['restaurant-menu'],
    vocabulary: SHOP_VOCAB,
  },
  {
    id: 'caviste',
  ...
  },
  {
    ...
    pluralName: 'Instituts de beauté',
    icon: 'sparkles',
  ...
  },
  {
    ...
    sortOrder: 40,
    extraModules: ['booking', 'products'],
  },
  {
    id: 'estheticienne',
    sector: 'beaute-bien-etre',
    name: 'Esthéticien(ne)',
    pluralName: 'Esthéticiens',
    icon: 'flower-2',
    schemaOrgType: 'BeautySalon',
    sortOrder: 50,
    extraModules: ['booking'],
  },
  {
    id: 'onglerie',
    sector: 'beaute-bien-etre',
    name: 'Onglerie / nail artist',
    pluralName: 'Ongleries',
    icon: 'hand',
  ...
  },
  {
    ...
    pluralName: 'Paysagistes',
    icon: 'trees',
    schemaOrgType: 'LandscapeArchitect',
    sortOrder: 80,
  },
  {
    id: 'carreleur',
  ...
  },
  {
    ...
    pluralName: 'Entreprises de rénovation',
    icon: 'hard-hat',
    schemaOrgType: 'GeneralContractor',
    sortOrder: 100,
    extraModules: ['team'],
  ...
  },
  {
    ...
    pluralName: 'Boutiques de décoration',
    icon: 'lamp',
    schemaOrgType: 'HomeGoodsStore',
    sortOrder: 70,
    vocabulary: SHOP_VOCAB,
  },
  {
    id: 'producteur',
    sector: 'commerce',
    name: 'Producteur / vente directe',
    pluralName: 'Producteurs',
    icon: 'wheat',
    schemaOrgType: 'Store',
    sortOrder: 80,
    vocabulary: SHOP_VOCAB,
  ...
  /* --- Services professionnels ------------------------------------------ */
  {
    ...
    pluralName: 'Cabinets de conseil',
    icon: 'presentation',
  ...
  },
  {
    ...
    schemaOrgType: 'ProfessionalService',
    sortOrder: 50,
    extraModules: ['portfolio', 'booking'],
  },
  {
  ...
  /* --- Immobilier -------------------------------------------------------- */
  {
    ...
    seoKeywords: ['agence immobilière', 'achat', 'vente', 'estimation'],
  },
  {
    id: 'mandataire',
    sector: 'immobilier',
    name: 'Mandataire immobilier',
    pluralName: 'Mandataires',
    icon: 'handshake',
    schemaOrgType: 'RealEstateAgent',
    sortOrder: 20,
    removeModules: ['team'],
  ...
  },
  {
    ...
    sector: 'immobilier',
    name: 'Diagnostiqueur',
    pluralName: 'Diagnostiqueurs',
    icon: 'clipboard-check',
    schemaOrgType: 'ProfessionalService',
    sortOrder: 40,
    extraModules: ['services'],
    removeModules: ['properties'],
  },
  ...
  /* --- Sante ------------------------------------------------------------- */
  {
    ...
    pluralName: 'Kinésithérapeutes',
    icon: 'activity',
    schemaOrgType: 'Physiotherapist',
    sortOrder: 10,
    extraModules: ['booking'],
  },
  {
  ...
  },
  {
    ...
    sector: 'sante',
    name: 'Psychologue',
    pluralName: 'Psychologues',
    icon: 'brain',
    schemaOrgType: 'Psychiatric',
    sortOrder: 40,
    extraModules: ['booking'],
    removeModules: ['team'],
  },
  ...
  },
  {
    id: 'concession',
    sector: 'automobile',
    name: 'Concession / vente',
    pluralName: 'Concessions',
    icon: 'car-front',
  ...
  },
  {
    id: 'lavage-auto',
    sector: 'automobile',
    name: 'Lavage & detailing',
    pluralName: 'Centres de lavage',
    icon: 'droplets',
  ...
  },
  {
    id: 'moto',
    sector: 'automobile',
    name: 'Moto & deux-roues',
    pluralName: 'Concessions moto',
    icon: 'bike',
    schemaOrgType: 'MotorcycleDealer',
    sortOrder: 50,
    extraModules: ['products'],
  },
  ...
  },
  {
    ...
    sector: 'sport',
    name: 'Club sportif',
    pluralName: 'Clubs sportifs',
    icon: 'trophy',
    schemaOrgType: 'SportsClub',
    sortOrder: 30,
    extraModules: ['events', 'blog'],
  },
  {
    id: 'yoga',
    sector: 'sport',
  ...
  },
  {
    ...
    sector: 'education',
    name: 'Auto-école',
    pluralName: 'Auto-écoles',
    icon: 'traffic-cone',
    schemaOrgType: 'DrivingSchool',
    sortOrder: 40,
    extraModules: ['booking'],
  },
  {
...
function buildDefinition(spec: BusinessSpec): BusinessDefinition {
  ...
  const modules = [...new Set([...sector.defaultModules, ...(spec.extraModules ?? [])])].filter(
    (id) => !removed.has(id),
  );
...
export function listBusinessesBySector(sectorId: string): readonly BusinessDefinition[] {
  return BUSINESSES.filter((b) => b.sector === sectorId).sort((a, b) => a.sortOrder - b.sortOrder);
}

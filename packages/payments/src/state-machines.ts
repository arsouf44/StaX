...
export const PROJECT_TIMELINE: ReadonlyArray<{
  ...
  },
  {
    key: 'creation',
    label: 'Creation',
    description: 'Notre equipe concoit et developpe votre site.',
  ...
  },
  {
    key: 'publish',
    label: 'Mise en ligne',
    description: 'Le site est publie sur votre domaine, en HTTPS.',
    statuses: ['approved', 'ready_to_publish', 'published'],
  },
  {
    key: 'maintenance',
    label: 'Maintenance',
    description: 'Nous assurons les mises a jour, la securite et le support.',
    statuses: ['maintenance'],
  },
];

export const PROJECT_STATUS_LABELS: Record<ProjectStatus, string> = {
  ordered: 'Commande recue',
  questionnaire_pending: 'Questionnaire a completer',
  assets_pending: 'En attente de vos elements',
  in_progress: 'Creation en cours',
...
export const SUBSCRIPTION_STATUS_LABELS: Record<SubscriptionStatus, string> = {
  ...
  unpaid: 'Impaye',
  cancel_at_period_end: 'Resiliation programmee',
  canceled: 'Resilie',
  paused: 'Suspendu',
};

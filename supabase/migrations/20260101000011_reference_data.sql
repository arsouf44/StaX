...
insert into public.business_sectors (slug, label, description, icon, sort_order) values
  ('restauration', 'Restauration', 'Restaurants, bars, boulangeries, traiteurs et métiers de bouche.', 'utensils', 10),
  ('beaute-bien-etre', 'Beauté & bien-être', 'Coiffure, esthétique, spa, massage et soins du corps.', 'sparkles', 20),
  ('artisanat', 'Artisanat & bâtiment', 'Métiers du bâtiment, de la rénovation et de l''artisanat.', 'hammer', 30),
  ('commerce', 'Commerce & boutique', 'Commerces de proximité, boutiques et vente en ligne.', 'shopping-bag', 40),
  ...
  ('hebergement-tourisme', 'Hébergement & tourisme', 'Hôtels, chambres d''hôtes, gîtes et activités touristiques.', 'bed-double', 70),
  ('sante', 'Santé & paramédical', 'Praticiens, cabinets et professions de santé.', 'stethoscope', 80),
  ('automobile', 'Automobile & mobilité', 'Garages, carrosseries, concessions et mobilité.', 'car', 90),
  ('sport', 'Sport & loisirs', 'Salles, clubs, coachs et activités sportives.', 'dumbbell', 100),
  ('evenementiel', 'Événementiel', 'Organisation, prestation et location événementielle.', 'party-popper', 110),
  ('education', 'Éducation & formation', 'Écoles, formateurs, soutien scolaire et auto-écoles.', 'graduation-cap', 120),
  ('associations', 'Associations', 'Associations, clubs et structurés a but non lucratif.', 'heart-handshake', 130),
  ('autre', 'Autre activité', 'Votre métier n''apparaît pas ? Nous l''ajoutons pour vous.', 'circle-ellipsis', 999);
...
insert into public.business_types (slug, sector_slug, label, plural_label, icon, schema_org_type, sort_order) values
  ...
  ('cafe', 'restauration', 'Cafe / salon de the', 'Cafés', 'coffee', 'CafeOrCoffeeShop', 50),
  ('boulangerie', 'restauration', 'Boulangerie', 'Boulangeries', 'croissant', 'Bakery', 60),
  ('patisserie', 'restauration', 'Pâtisserie', 'Pâtisseries', 'cake-slice', 'Bakery', 70),
  ...
  ('institut-beaute', 'beaute-bien-etre', 'Institut de beauté', 'Instituts de beauté', 'sparkles', 'BeautySalon', 30),
  ('spa', 'beaute-bien-etre', 'Spa', 'Spas', 'waves', 'DaySpa', 40),
  ('estheticienne', 'beaute-bien-etre', 'Esthéticien(ne)', 'Esthéticiens', 'flower-2', 'BeautySalon', 50),
  ...
  ('electricien', 'artisanat', 'Électricien', 'Électriciens', 'zap', 'Electrician', 20),
  ('menuisier', 'artisanat', 'Menuisier', 'Menuisiers', 'ruler', 'GeneralContractor', 30),
  ('macon', 'artisanat', 'Maçon', 'Maçons', 'brick-wall', 'GeneralContractor', 40),
  ('peintre', 'artisanat', 'Peintre en bâtiment', 'Peintres', 'paint-roller', 'HousePainter', 50),
  ...
  ('renovation', 'artisanat', 'Entreprise de rénovation', 'Entreprises de rénovation', 'hard-hat', 'GeneralContractor', 100),
  -- Commerce
  ('boutique', 'commerce', 'Boutique', 'Boutiques', 'shopping-bag', 'Store', 10),
  ('pret-a-porter', 'commerce', 'Prêt-a-porter', 'Boutiques de mode', 'shirt', 'ClothingStore', 20),
  ('fleuriste', 'commerce', 'Fleuriste', 'Fleuristes', 'flower', 'Florist', 30),
  ('epicerie', 'commerce', 'Épicerie fine', 'Épiceries', 'apple', 'GroceryStore', 40),
  ...
  ('freelance', 'services-professionnels', 'Independant / freelance', 'Indépendants', 'user-round', 'ProfessionalService', 70),
  ('assurance', 'services-professionnels', 'Courtier / assurance', 'Courtiers', 'shield-check', 'InsuranceAgency', 80),
  -- Immobilier
  ('agence-immobiliere', 'immobilier', 'Agence immobilière', 'Agences immobilières', 'building-2', 'RealEstateAgent', 10),
  ...
  ('hotel', 'hebergement-tourisme', 'Hôtel', 'Hôtels', 'bed-double', 'Hôtel', 10),
  ('chambre-hotes', 'hebergement-tourisme', 'Chambre d''hôtes', 'Chambres d''hôtes', 'bed', 'BedAndBreakfast', 20),
  ('gite', 'hebergement-tourisme', 'Gite / location saisonniere', 'Gîtes', 'tent-tree', 'LodgingBusiness', 30),
  ...
  -- Sante
  ('kinesitherapeute', 'sante', 'Kinésithérapeute', 'Kinésithérapeutes', 'activity', 'Physiotherapist', 10),
  ('osteopathe', 'sante', 'Ostéopathe', 'Ostéopathes', 'bone', 'MedicalBusiness', 20),
  ...
  ('veterinaire', 'sante', 'Vétérinaire', 'Vétérinaires', 'paw-print', 'VeterinaryCare', 60),
  -- Automobile
  ...
  ('location-materiel', 'evenementiel', 'Location de matériel', 'Loueurs', 'package', 'ProfessionalService', 40),
  -- Education
  ('ecole', 'education', 'Ecole / etablissement', 'Écoles', 'school', 'EducationalOrganization', 10),
  ...
  ('auto-ecole', 'education', 'Auto-école', 'Auto-écoles', 'traffic-cone', 'DrivingSchool', 40),
  ('musique', 'education', 'École de musique', 'Écoles de musique', 'music', 'EducationalOrganization', 50),
  -- Associations
  ...
  -- Autre
  ('autre-activite', 'autre', 'Autre activité', 'Autres activités', 'circle-ellipsis', 'LocalBusiness', 10);

-- -----------------------------------------------------------------------------
--  Modules metier
-- -----------------------------------------------------------------------------
insert into public.business_modules (slug, label, description, icon, category, required_feature, sort_order) values
  ('contact', 'Formulaire de contact', 'Recevez les messages de vos visiteurs dans votre boîte de réception.', 'mail', 'crm', null, 10),
  ...
  ('gallery', 'Galerie photos', 'Mettez en valeur votre lieu, vos produits et vos réalisations.', 'images', 'content', null, 30),
  ('testimonials', 'Avis clients', 'Publiez les témoignages de vos clients satisfaits.', 'quote', 'marketing', null, 40),
  ('faq', 'Questions fréquentes', 'Répondez aux questions recurrentes et gagnez du temps.', 'help-circle', 'content', null, 50),
  ('team', 'Équipe', 'Présentez les personnes qui font votre entreprise.', 'users', 'content', null, 60),
  ('services', 'Prestations & tarifs', 'Détaillez vos prestations, leurs durées et leurs tarifs.', 'list-checks', 'content', null, 70),
  ('service-area', 'Zones d''intervention', 'Indiquez les communes et le rayon que vous couvrez.', 'map-pin', 'content', null, 80),
  ('portfolio', 'Réalisations', 'Un portfolio avant/apres pour prouver votre savoir-faire.', 'layout-grid', 'content', null, 90),
  ('quotes', 'Demande de devis', 'Un formulaire structuré qui qualifié vos demandes entrantes.', 'file-text', 'crm', null, 100),
  ('restaurant-menu', 'Carte & menus', 'Catégories, plats, prix, allergènes, formules midi et soir.', 'utensils', 'content', null, 110),
  ('booking', 'Réservations', 'Creneaux, capacites, confirmations et rappels automatiques.', 'calendar-check', 'booking', 'bookings', 120),
  ('products', 'Catalogue produits', 'Produits, variantes, catégories et stock simplifié.', 'package', 'commerce', 'ecommerce', 130),
  ...
  ('rooms', 'Chambres & hébergements', 'Chambres, équipements, tarifs et demandes de sejour.', 'bed-double', 'content', null, 170),
  ('events', 'Événements', 'Agenda, dates et inscriptions a vos événements.', 'calendar-days', 'content', null, 180),
  ('blog', 'Actualites', 'Publiez vos nouvelles et alimentez votre référencement.', 'newspaper', 'marketing', 'blog', 190),
...
insert into public.features (key, label, description, category, kind, unit) values
  ('custom_domain', 'Nom de domaine personnalisé', 'Connectez votre propre nom de domaine avec HTTPS automatique.', 'site', 'boolean', null),
  ('seo_tools', 'SEO technique', 'Balises, sitemap, données structurées et redirections.', 'site', 'boolean', null),
  ('content_editor', 'Éditeur de contenu', 'Modifiez textes, photos et sections sans coder.', 'site', 'boolean', null),
  ('scheduled_publishing', 'Publication programmée', 'Préparez vos mises a jour et publiez a la date choisie.', 'site', 'boolean', null),
  ('version_history', 'Historique des versions', 'Revenez a une version antérieure a tout moment.', 'site', 'boolean', null),
  ('advanced_animations', 'Animations avancées', 'Transitions et interactions travaillees sur mesure.', 'design', 'boolean', null),
  ('custom_design', 'Design sur mesure', 'Composants et compositions spécifiques a votre marque.', 'design', 'boolean', null),
  ('bookings', 'Réservations', 'Moteur de creneaux, capacites et confirmations.', 'modules', 'boolean', null),
  ...
  ('advanced_analytics', 'Statistiques avancées', 'Sources, conversions et suivi des objectifs.', 'analytics', 'boolean', null),
  ('multi_language', 'Multilingue', 'Plusieurs langues sur un même site.', 'site', 'boolean', null),
  ('team_collaboration', 'Collaboration', 'Invitez des collaborateurs avec des rôles distincts.', 'organisation', 'boolean', null),
  ('priority_support', 'Support prioritaire', 'Traitement prioritaire de vos demandes.', 'support', 'boolean', null),
  ('max_sites', 'Sites inclus', 'Nombre de sites gérés dans l''espace.', 'limits', 'limit', 'site'),
  ('max_pages', 'Pages', 'Nombre de pages du site.', 'limits', 'limit', 'page'),
  ('max_team_members', 'Collaborateurs', 'Nombre de membres de l''équipe.', 'limits', 'limit', 'membre'),
  ...
  ('max_monthly_submissions', 'Messages mensuels', 'Nombre de messages reçus par mois.', 'limits', 'limit', 'message'),
...
insert into public.subprocessors (name, purpose, location, transfer_safeguards, privacy_url, category, sort_order) values
  ('Cloudflare, Inc.', 'Hébergement edge, CDN, protection réseau et certificats TLS.',
  ...
  ('Supabase, Inc.', 'Base de données PostgreSQL, authentification et stockage de fichiers.',
   'Union europeenne (région de projet configurable)',
...
insert into public.system_health (key, label, status, detail) values
  ('database', 'Base de données', 'unknown', 'En attente de la première sonde.'),
  ('stripe_webhooks', 'Webhooks Stripe', 'unknown', 'En attente du premier événement.'),
  ('email_provider', 'Fournisseur d''e-mails', 'unknown', 'En attente du premier envoi.'),
  ('domain_verification', 'Vérification des domaines', 'unknown', 'En attente de la première tâche.'),
  ('analytics_rollup', 'Agregation des statistiques', 'unknown', 'En attente de la première execution.'),
  ('scheduled_publishing', 'Publications programmees', 'unknown', 'En attente de la première execution.'),
  ('backups', 'Sauvegardes PostgreSQL', 'not_configured',
   'La sauvegarde est assuree par Supabase. Renseignez la sonde pour afficher un état réel.');
